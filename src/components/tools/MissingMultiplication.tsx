...
const generateQuestion = (max: number) => {
  let a, b;
  let c = Math.floor(Math.random() * (max - 1)) + 2;
  if (max <= 10) {
          ...
          >
            ...
            <div className="text-center space-y-4 shrink-0 mb-12">
              <div className="space-y-1">
                 <h1 className="text-5xl lg:text-6xl font-black text-slate-900 tracking-tighter uppercase leading-none">Missing Multiplication</h1>
              </div>
            </div>
...
export default MissingMultiplication;
