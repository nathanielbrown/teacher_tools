      ...
      <AnimatePresence mode="wait">
        {status === 'setup' ? (
          <motion.div
            ...
            className="w-full max-w-4xl flex flex-col items-center gap-12 lg:gap-20 italic px-4"
          >
            <div className="text-center space-y-4">
              <h1 className="text-5xl lg:text-7xl font-black text-slate-900 tracking-tight uppercase italic leading-none">Emoji Match</h1>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8 w-full max-w-4xl">
          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <h2 className="text-6xl lg:text-7xl font-black text-slate-900 uppercase tracking-tighter leading-none">Winner!</h2>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-8 lg:gap-12">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-4xl lg:text-5xl font-black text-slate-800 tabular-nums">{elapsed}s</span>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-4xl lg:text-5xl font-black text-slate-800 tabular-nums">{moves}</span>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 w-full max-w-md">
              <button
                onClick={() => setStatus('setup')}
                className="flex-1 py-4 lg:py-6 bg-slate-100 text-slate-600 font-black text-lg rounded-2xl hover:bg-slate-200 transition-all active:scale-95 uppercase tracking-widest"
              >
                Exit
              </button>
              <button
