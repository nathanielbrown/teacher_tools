...
import { Calculator, CheckCircle2, XCircle, RefreshCcw, ChevronRight, Star, Trophy, ArrowLeft, Minus, Info } from 'lucide-react';
        ...
        infoContent={
          <>
            <p>
              ...
              Identify the missing number in the subtraction equation (a - b = c).
            </p>
            <p>
               ...
               {Array.from({ length: 10 }).map((_, i) => (
                 <div 
                   ...
                   className={`w-2.5 h-2.5 rounded-full transition-colors ${
                     ...
                     i === currentIndex ? 'bg-blue-500 animate-pulse' : 'bg-slate-200'
                   }`}
                 />
               ))}
             </div>
