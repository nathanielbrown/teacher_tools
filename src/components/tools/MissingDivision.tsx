          ...
          >
            ...
            <div className="text-center space-y-4 shrink-0 mb-12">
              <div className="w-20 h-20 bg-indigo-600 rounded-[1.5rem] flex items-center justify-center text-white mx-auto  rotate-3 border-4 border-white mb-6">
                <Divide size={32} strokeWidth={3} />
              </div>
              <div className="space-y-1">
                 <h1 className="text-5xl lg:text-6xl font-black text-slate-900 tracking-tighter uppercase leading-none">Missing Division</h1>
            ...
            <div className="bg-slate-50/50 p-12 lg:p-16 rounded-[4rem] border-4 border-white  grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
              {[
                { level: 10, label: 'Easy', desc: '1-10', icon: '🍀', color: 'indigo' },
...
export default MissingDivision;
