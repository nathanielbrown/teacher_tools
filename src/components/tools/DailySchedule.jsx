...
import { defaultSchedules, SCHOOL_EMOJIS, DAYS, defaultSchedule } from './DailySchedule/scheduleData';

export const DailySchedule = () => {
  const [schedules, setSchedules] = useLocalStorage('teacherToolsSchedules', defaultSchedules);
