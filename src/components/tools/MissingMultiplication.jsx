...
import { Calculator, CheckCircle2, XCircle, RefreshCcw, ChevronRight, Star, Trophy, ArrowLeft, X } from 'lucide-react';
    ...
    return (
      <div className="max-w-4xl mx-auto h-full flex flex-col items-center justify-center p-4">
        ...
        >
          ...
          <h1 className="text-5xl font-black text-gray-800 tracking-tight">Missing Multiplier</h1>
            ...
            {Array.from({ length: 10 }).map((_, i) => (
              <div 
                ...
                className={`w-3 h-3 rounded-full transition-colors ${
                  ...
                  i === currentIndex ? 'bg-purple-500 animate-pulse' : 'bg-gray-200'
                }`}
              />
            ))}
          </div>
