export const CURRENCIES = {
  ...
  USD: {
    symbol: '$',
    items: [
      { id: '100d', value: 100, type: 'note', color: 'bg-emerald-100 border-emerald-600 text-emerald-900', label: '$100', sizeClass: 'w-[120px] h-[50px] text-base' },
      { id: '50d', value: 50, type: 'note', color: 'bg-emerald-100 border-emerald-600 text-emerald-900', label: '$50', sizeClass: 'w-[120px] h-[50px] text-base' },
      { id: '20d', value: 20, type: 'note', color: 'bg-emerald-100 border-emerald-600 text-emerald-900', label: '$20', sizeClass: 'w-[120px] h-[50px] text-base' },
      { id: '10d', value: 10, type: 'note', color: 'bg-emerald-100 border-emerald-600 text-emerald-900', label: '$10', sizeClass: 'w-[120px] h-[50px] text-base' },
      { id: '5d', value: 5, type: 'note', color: 'bg-emerald-100 border-emerald-600 text-emerald-900', label: '$5', sizeClass: 'w-[120px] h-[50px] text-base' },
      { id: '1d', value: 1, type: 'note', color: 'bg-emerald-100 border-emerald-600 text-emerald-900', label: '$1', sizeClass: 'w-[120px] h-[50px] text-base' },
      { id: '25c', value: 0.25, type: 'coin', color: 'bg-gray-200 border-gray-400 text-gray-800', label: '25¢', sizeClass: 'w-[52px] h-[52px] text-sm' },
      { id: '10c', value: 0.10, type: 'coin', color: 'bg-gray-200 border-gray-400 text-gray-800', label: '10¢', sizeClass: 'w-[38px] h-[38px] text-xs' },
      { id: '5c', value: 0.05, type: 'coin', color: 'bg-gray-200 border-gray-400 text-gray-800', label: '5¢', sizeClass: 'w-[44px] h-[44px] text-xs' },
    ]
  },
  EUR: {
    symbol: '€',
    items: [
      { id: '100e', value: 100, type: 'note', color: 'bg-emerald-100 border-emerald-600 text-emerald-900', label: '100€', sizeClass: 'w-[120px] h-[50px] text-base' },
      { id: '50e', value: 50, type: 'note', color: 'bg-orange-100 border-orange-600 text-orange-900', label: '50€', sizeClass: 'w-[115px] h-[48px] text-base' },
      { id: '20e', value: 20, type: 'note', color: 'bg-blue-100 border-blue-600 text-blue-900', label: '20€', sizeClass: 'w-[110px] h-[46px] text-base' },
      { id: '10e', value: 10, type: 'note', color: 'bg-red-100 border-red-600 text-red-900', label: '10€', sizeClass: 'w-[105px] h-[44px] text-base' },
      { id: '5e', value: 5, type: 'note', color: 'bg-gray-100 border-gray-600 text-gray-900', label: '5€', sizeClass: 'w-[100px] h-[42px] text-base' },
      { id: '2c', value: 2, type: 'coin', color: 'bg-yellow-200 border-gray-400 text-gray-800', label: '2€', isBimetallic: true, innerColor: 'bg-gray-200', sizeClass: 'w-[56px] h-[56px] text-sm' },
      { id: '1c', value: 1, type: 'coin', color: 'bg-gray-200 border-yellow-500 text-gray-800', label: '1€', isBimetallic: true, innerColor: 'bg-yellow-200', sizeClass: 'w-[50px] h-[50px] text-sm' },
      { id: '50cc', value: 0.50, type: 'coin', color: 'bg-yellow-400 border-yellow-600 text-yellow-900', label: '50c', sizeClass: 'w-[54px] h-[54px] text-sm' },
      { id: '20cc', value: 0.20, type: 'coin', color: 'bg-yellow-400 border-yellow-600 text-yellow-900', label: '20c', isPoly: true, polyPoints: 'polygon(50% 0%, 90% 20%, 100% 60%, 75% 100%, 25% 100%, 0% 60%, 10% 20%)', sizeClass: 'w-[48px] h-[48px] text-xs' },
      { id: '10cc', value: 0.10, type: 'coin', color: 'bg-yellow-400 border-yellow-600 text-yellow-900', label: '10c', sizeClass: 'w-[42px] h-[42px] text-xs' },
      { id: '5cc', value: 0.05, type: 'coin', color: 'bg-yellow-400 border-yellow-600 text-yellow-900', label: '5c', sizeClass: 'w-[40px] h-[40px] text-xs' },
    ]
  }
};
